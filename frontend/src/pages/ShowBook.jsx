  ...
  return (
    <div className="p-4">
      ...
      {loading ? (
        ...
        <div className="flex flex-col border-2 border-sky-400 rounded-x1 w-fix p-4">
          <div className="flex flex-col border-2 border-sky-400 rounded-xl w-fit p-4">
            ...
            <div className="my-4">
              <span className="text-x1 mr-4 text-grey-500">Date Created</span>
              <span>{new Date(book.createdAt).toString()}</span>
            </div>
            <div className="my-4">
              <span className="text-x1 mr-4 text-grey-500">
                Last Update Time
              </span>
